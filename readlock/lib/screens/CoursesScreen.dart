...
class CoursesScreenState extends State<CoursesScreen> {
  ...
  List<Widget> GenreSectionContent(
    String genreName,
    List<Map<String, dynamic>> coursesInGenre,
  ) {
    ...
    contentWidgets.addAll(CourseCards(coursesInGenre));
...
class CourseCard extends StatelessWidget {
  ...
  Widget CourseHeader(
    ...
    return Div.row([
      // Course content area
      Expanded(child: CourseContent(title, description)),
  ...
  Widget CourseStats() {
    ...
    return Div.row([
      // Book icon
      Icon(Icons.book_outlined, color: iconColor, size: 16),
