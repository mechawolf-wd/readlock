...
import 'package:readlock/course_screens/widgets/CCIntro.dart';
import 'package:readlock/course_screens/widgets/CCTextContent.dart';
import 'package:readlock/course_screens/widgets/CCOutro.dart';
import 'package:readlock/course_screens/widgets/CCDesignExamplesShowcase.dart';
import 'package:readlock/course_screens/widgets/CCReflection.dart';
import 'package:readlock/course_screens/widgets/CCQuote.dart';
import 'package:readlock/course_screens/widgets/CCTrueFalseQuestion.dart';
import 'package:readlock/course_screens/widgets/CCFillGapQuestion.dart';
import 'package:readlock/course_screens/widgets/CCIncorrectStatement.dart';
import 'package:readlock/course_screens/widgets/CCEstimatePercentage.dart';
import 'package:readlock/course_screens/widgets/CCMultipleChoice.dart';
import 'package:readlock/course_screens/widgets/CCReflectionQuestion.dart';
  ...
  Widget QuestionWidget(QuestionContent questionContent) {
    ...
    switch (questionContent.type) {
      ...
      case QuestionType.estimatePercentage:
        {
          // Handle estimate-percentage questions
          // Convert QuestionContent to EstimatePercentageContent
          final estimateContent = EstimatePercentageContent(
            id: questionContent.id,
            title: questionContent.title,
            question: questionContent.question,
            correctPercentage:
                questionContent.correctAnswerIndices.isNotEmpty
                ? questionContent.correctAnswerIndices.first
                : 50,
