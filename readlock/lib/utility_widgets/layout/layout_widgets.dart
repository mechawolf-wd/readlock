// Layout widgets for simplified Flutter UI development
// Provides Div widget for layout containers and Spacing widget for consistent spacing
...
class Div extends StatelessWidget {
  ...
  /// Examples:
  /// ```dart
  /// mainAxisAlignment: 'start'                         // String (preferred)
  /// mainAxisAlignment: 'center'                        // String (preferred)
  /// mainAxisAlignment: 'spaceBetween'                  // String (preferred)
  /// mainAxisAlignment: 'spaceEvenly'                   // String (preferred)
  /// mainAxisAlignment: MainAxisAlignment.center        // Enum (still supported)
  /// mainAxisAlignment: MainAxisAlignment.spaceBetween  // Enum (still supported)
  /// ```
  ...
  /// Examples:
  /// ```dart
  /// crossAxisAlignment: 'start'                        // String (preferred)
  /// crossAxisAlignment: 'center'                       // String (preferred)
  /// crossAxisAlignment: 'stretch'                      // String (preferred)
  /// crossAxisAlignment: 'baseline'                     // String (preferred)
  /// crossAxisAlignment: CrossAxisAlignment.center      // Enum (still supported)
  /// crossAxisAlignment: CrossAxisAlignment.stretch     // Enum (still supported)
  /// ```
