...
/// @Class: Static data provider for available courses
class CourseData {
        ...
        CourseSection(
          ...
          content: [
            IntroContent(
              ...
              question:
                  'Why do some ideas spread like wildfire while others vanish without a trace?',
              overview:
            ...
            TransitionContent(
              ...
              message:
                  'You\'ve seen how viral content can transform ideas into movements. But what makes some content irresistible to share?',
              callToAction:
        ...
        CourseSection(
          ...
          content: [
            ...
            TransitionContent(
              ...
              message:
                  'You now understand the psychological triggers behind viral content. Ready to see how this applies to real situations?',
              callToAction:
            ...
            SummaryContent(
              id: 'viral_summary',
              title:
                  'Congratulations! You\'ve Mastered Viral Mechanics',
              mainInsight:
                  'Viral content isn\'t random—it follows predictable patterns you can harness. The most powerful viral ideas give people social currency while triggering emotions and everyday reminders. Master these mechanics, and you\'ll never create forgettable content again.',
              examples: [
                RealWorldExample(
                  context: 'Marketing Manager at SaaS Company',
                  application:
                  ...
                  outcome:
                      'Launch video shared 300% more than previous campaigns, generating 2,000 qualified leads in first week.',
                ),
                RealWorldExample(
                  context: 'Local Restaurant Owner',
                  application:
                  ...
                  outcome:
                      'Social media mentions increased 500%, weekend reservations booked solid for three months.',
                ),
                RealWorldExample(
                  ...
                  outcome:
                      'Engagement rates doubled, landed three brand partnership deals worth \$15K total.',
                ),
              ],
            ),
          ],
        ...
        CourseSection(
          ...
          content: [
            IntroContent(
              ...
              question:
                  'Why do you pull on doors that should be pushed, get confused by simple interfaces, and blame yourself when things don\'t work?',
              overview:
        ...
        CourseSection(
          ...
          content: [
            ...
            StoryContent(
              ...
              text:
                  'When you press an elevator button and it lights up, that\'s feedback.\n\nWhen your phone vibrates after sending a message, that\'s feedback.\n\nWithout feedback, we\'re left wondering:\n• "Did it work?"\n• "Should I try again?"\n• "Is something broken?"\n\nGreat design constantly communicates with users, confirming actions and guiding next steps.',
            ),
            ReflectionContent(
              id: 'design_reflection',
              title: 'Design Detective',
              prompt:
                  'Look around you right now. Pick any object within reach. How does its design tell you how to use it? What frustrates you about poorly designed objects in your daily life?',
              insight:
        ...
        CourseSection(
          ...
          content: [
            IntroContent(
              ...
              question:
                  'How do you build products people actually want instead of beautiful failures that nobody needs?',
              overview:
